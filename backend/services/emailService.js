...
const templates = {
  bookingConfirmation: (data) => `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <div style="background: #f9fafb; padding: 16px; border-radius: 8px; margin: 16px 0;">
        <p><strong>Vehicle:</strong> ${data.bikeName}</p>
        <p><strong>Date:</strong> ${data.date}</p>
        <p><strong>Duration:</strong> ${data.hours} hours</p>
        <p><strong>Total:</strong> ${data.totalPrice} TK</p>
        <p><strong>Advance Paid:</strong> ${data.advancePaid} TK</p>
      </div>
  ...
  paymentConfirmation: (data) => `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <p>Hi ${data.userName},</p>
      <p>We have received your payment of <strong>${data.amount} TK</strong>.</p>
      <div style="background: #f9fafb; padding: 16px; border-radius: 8px; margin: 16px 0;">
        <p><strong>Booking ID:</strong> ${data.bookingId}</p>
        <p><strong>Amount:</strong> ${data.amount} TK</p>
  ...
  bookingCancellation: (data) => `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      ${data.refundAmount ? `<p>Refund amount: <strong>${data.refundAmount} TK</strong> will be credited within 3-5 business days.</p>` : ''}
    </div>
  `,
};
